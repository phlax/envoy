...
filegroup(
    ...
    # Kafka clusters.
    # with_ssl/with_zlib are label flags allowing the (currently disabled, see
    # librdkafka.patch/librdkafka_build in bazel/foreign_cc/BUILD) ssl and zlib
    # support to be toggled from the command line without changing behavior by
    # default.
    LIBRDKAFKA_BUILD_CONTENT = BUILD_ALL_CONTENT + """
